...
$(document).ready(function(){
	...
	Detals.prototype.addList = function(dataFilter) {
		...
		if(dataFilter){
			...
			let li = $(`<li></li>`);
			li.html( `<img class="loaderGIF" src="public1/images/loader.gif">`);
			ul.append($(li))
		}
		$('.car-list').append(ul);
	};
	Detals.prototype.addButton = function(parentLi) {
		...
		var buttons = 	`<div class="buttons">
							<button data-proto="showInfoModal" class="button-info active"><img src="./public1/images/${arrImgIconPath[0].active}">Info</button>
							<button data-proto="showIncomeModal" class="button-income"><img src="./public1/images/${arrImgIconPath[1].default}">Income</button>
							<button data-proto="showExpensesModal" class="button-expenses"><img src="./public1/images/${arrImgIconPath[2].default}">Expenses</button>
							<button data-proto="showComplianceModal" class="button-compliance"><img src="./public1/images/${arrImgIconPath[3].default}">Compliance</button>
						</div>`
	...
	Detals.prototype.addButtonEvent = function(imgPathArr,thatBtnsWrap, thatParentLi) {
		...
		Array.from(thatBtnsWrap.children()).forEach((element, index)=>{
			element.onclick = function(){
				...
				Array.from(thatBtnsWrap.children()).forEach((element, index)=>{
					$(element).find('img').attr('src', `./public1/images/${imgPathArr[index].default}`);
				})
				// ______________________
				$(this).find('img').attr('src', `./public1/images/${imgPathArr[index].active}`);
