...
<div class="container">
 ...
 <span style="font-size:18px;"><strong>Create Challan</strong></span><a href="<?php echo URL; ?>challan/index"><button id="btnAdd" type="button" class="btn btn-info pull-right"><i class="fa fa-angle-left"></i> Back</button></a>
 <br clear="all" />
<div class="or-box">
 </div>
 ...
 <?php if($challanno == ""){ $challanno=$this->challanno;} //echo $challanno; ?>
	<div class="form-group col-xs-6">
  <label class="control-label col-xs-6" for="challanno">Challan No:</label>
	   <div class="col-xs-6"> 
	 <input type="text" class="form-control" name="challanno" id="challanno" placeholder="Enter Challan no" value="<?php echo ($challanno+1); ?>">
  	</div>
   </div>
