 ...
 <center>
  ...
  <form action="#" method="POST">
       ...
       <div style="text-align: center;">
         ...
         <th>Entry - Tare</th> 
         <th>Load IN</th> 
         <th>Tare - Loding in</th> 
         <th>Load OUT</th>
         <th>Loding in - loading out</th>
         <th>Gross</th>
         <th>Gross Weight Time</th>
         <th>loading out - gross</th>                                      
         <th>Net </th>
...
success: function(returnedData) {
  ...
  displayTable=[];
    ...
    oTable.clear().draw();
     ...
     txt +="<tr><td>"+returnedData[i].gatepass_no+"</td>";
     txt +="<td>"+Vehicle+"</td>";
     ...
     txt +="<td>"+get_time_diff(returnedData[i].datetime_in,returnedData[i].tare_weight_time)+"</td>";
     txt +="<td>"+formatDateTime(returnedData[i].loading_timeIN)+"</td>";
     txt +="<td>"+get_time_diff(returnedData[i].tare_weight_time,returnedData[i].loading_timeIN)+"</td>";
     txt +="<td>"+formatDateTime(returnedData[i].loading_timeOUT)+"</td>";
     txt +="<td>"+get_time_diff(returnedData[i].loading_timeIN,returnedData[i].loading_timeOUT)+"</td>";
     txt +="<td>"+returnedData[i].grossweight+"</td>";
     txt +="<td>"+returnedData[i].gross_weight_time+"</td>";
     txt +="<td>"+get_time_diff(returnedData[i].loading_timeOUT,returnedData[i].gross_weight_time)+"</td>";
     ...
     txt +="<td>"+get_time_diff(returnedData[i].gross_weight_time,returnedData[i].datetime_out)+"</td>";
