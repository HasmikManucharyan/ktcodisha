           ...
           ////  console.log(returnedData[0].Total);
            ...
            for( i = 0; i < returnedData.length; i++ ) {
                ...
                var str = returnedData[i].vehicle_no;
                 ...
                 var Entry_Time = returnedData[i].challan_entry_time;
                 var TimeInvolved="";
                 var ConvertTime="";
                 if(Entry_Time!=""){
                    TimeInvolved = 
...
$.ajax({
        ...
        success: function(returnedData) {
           ...
           ////  console.log(returnedData[0].Total);
            ...
            for( i = 0; i < returnedData.length; i++ ) {
                allVehicleStatus[returnedData[i].deviceid]="Waiting For Exit";
                var str = returnedData[i].vehicle_no;
                 str = str.replace(/\s/g,'');
                 var Vehicle = substr_replace(str," ",5,0);
                 var Driver = returnedData[i].driver_name;
...
$.ajax({
        ...
        success: function(returnedData) {
           ...
           ////  console.log(returnedData[0].Total);
            ...
            for( i = 0; i < returnedData.length; i++ ) {
                allVehicleStatus[returnedData[i].deviceid]="EXIT DONE";
                var str = returnedData[i].vehicle_no;
                 str = str.replace(/\s/g,'');
                 var Vehicle = substr_replace(str," ",5,0);
                 var Driver = returnedData[i].driver_name;
...
$.ajax({
        ...
        success: function(returnedData) {
           ...
           ////  console.log(returnedData[0].Total);
            ...
            for( i = 0; i < returnedData.length; i++ ) {
                allVehicleStatus[returnedData[i].deviceid]="Unloading Done";
                var str = returnedData[i].vehicle_no;
                 str = str.replace(/\s/g,'');
                 var Vehicle = substr_replace(str," ",5,0);
                 var Driver = returnedData[i].driver_name;
...
// //mobileappjsonctrips
// $.ajax({
//         url: "<?php //echo URL; ?>challan/mobileappjsonctrips",
//         type: "GET",
//         data: {  
//         vendorCode: <?php //echo $this->vendorCode; ?>
//         },
...
//         success: function(returnedData) {
//             for( i = 0; i < returnedData.length; i++ ) {
//                 ctrips[returnedData[i].deviceid]=returnedData[i].Trips;
//                   TQty[returnedData[i].deviceid]=returnedData[i].TQty;
//             }
...
//mobileappjsonunloaded
$.ajax({
        url: "<?php echo URL; ?>challan/getAllTripsgrid",
        type: "GET",
        data: {  
        vendorCode: <?php echo $this->vendorCode; ?>
        },
     ...
     //  $("#mobileappjsonunloaded").text(returnedData.length);
      var displayTable=[];
            ...
            for( i = 0; i < yourArray.length; i++ ) {
               ...
               console.log(JSON.stringify(returnedData[i]));
                //alert(returnedData[i].vehicle_no+" "+returnedData[i][0].time);
               // if(returnedData[i].0.hasOwnProperty('time')){
                    FirstTrip =  ValidateTrips(returnedData[i].First);
                  //  BG1 = ValidateTripsColor(returnedData[i].First);
               // }
              //  if(returnedData[i].1.hasOwnProperty('time')){
                    SecondTrip =  ValidateTrips(returnedData[i].Second);
                  //  BG2 = ValidateTripsColor(returnedData[i].Second);
               // }
                // if(returnedData[i].2.hasOwnProperty('time')){
                     ThirdTrip =  ValidateTrips(returnedData[i].Third);
                  //   BG3 = ValidateTripsColor(returnedData[i].Third);
                     TQ = ValidateTrips(returnedData[i].TQ)
                // }
                var BG ="#fff";
                var str = returnedData[i].vehicle_no;
                str = str.replace(/\s/g,'');
                ...
                txt+="<td style='background-color:"+BG+";'>"+FirstTrip+"</td>"; 
                txt+="<td style='background-color:"+BG+";'>"+SecondTrip+"</td>";
                txt+="<td style='background-color:"+BG+";'>"+ThirdTrip+"</td>";
                txt+="<td>"+TQ+"</td>"; 
                txt+="<td>"+allVehicleStatus[returnedData[i].deviceid]+"</td></tr>"; 
