...
<nav class="navbar navbar-inverse navbar-static-top navbar-custom" role="navigation">
        <div class="container">
            ...
            <?php //echo Roles::handleRole("master/vehicle"); ?>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <?php  if(Session::get('loggedIn')==true) { ?>
                           ...
                           <?php if(Roles::handleRole("master")>0){ ?> <li><a href="<?php echo URL; ?>master/vehiclemaster">VEHICLE</a></li> <?php } ?>
                           ...
                           <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo URL; ?>vts/reportsevents">EVENT REPORT</a></li>
                           </ul>
                           </li>
                           <li><a href="<?php echo URL; ?>vts/activitylog">ACTIVITY LOG</a></li>
            ...
            <div class="notify-drop-footer text-center">
            	<a href=""><i class="fa fa-eye"></i> See All</a>
                           ...
                           <li><a href="<?php echo URL; ?>login/logout">LOGOUT</a></li>
							<?php  }  else { ?>   
         					<li class="social pull-right"><a href="<?php echo URL; ?>">HOME</a></li>
 							<?php } ?>
						</ul>
            </div>
            <!-- /.navbar-collapse -->
