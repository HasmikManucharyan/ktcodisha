  ...
  <div class="tab-content">
     <div id="home" class="tab-pane fade in active">
        <div class="white_div" style="">
           <div class="title_div">
             <span class="title_pra" style="font-size:18px;"><strong>Historic Playback</strong></span>
         ...
         <div class="col-md-12" style="margin-top: 50px;">
             <div class="col-md-offset-1 col-md-5">
                 <div style="display: flex;">
                     <div class="box">
                           <p class="input_title">Devices:</p>
                      </div>
                        <div class="box box2"><select class="input_bar form-control" name="deviceid" id="deviceid" style="width:100%;">	
                    ...
                    <div class="col-md-5">
                      <div style="display: flex;">
                        ...
                        <div class="box box2"><input class="input_bar form-control" type="date" name="date" value="<?php echo $this->mdate; if($this->mdate==''){echo date("Y-m-d");}?>"></div>
                     </div>
                    </div>
           </div>
       <div style="text-align: center;">
                  <input type="button" class="btn btn-default sbmt_btn" name="submit" id="submitbtn" value="submit">
               </div>
	 </form>
...
<div id="myStatus"></div>
<div id="map" style="width:100%;height:475px;background:white;padding-left:5px; padding-right:5px;"></div>
	
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=true&key=AIzaSyDvoRDqzE5AutQBzNBrYna6c0e3FyJPJ1g&country=IN"></script>
...
if(parseInt(Pspeed[count])>0){																			  
			 ...
			 myIcon ='<?php echo URL; ?>public/images/maps/model/Truck-G.gif';
			 } else {
				 myIcon ='<?php echo URL; ?>public/images/maps/model/Truck-Y.gif';
