...
divobj2.value = to;
  ...
  <span style="font-size:18px;"><strong>Fuel View</strong></span>
  <br clear="all" />
<div class="or-box">
 </div>
 <center>
  ...
  <form action="<?php echo URL; ?>vts/fuelview" method="POST">
 ...
 <option value="<?php echo $value['id']; ?>" <?php if($value['id']==$this->deviceid){ echo "selected=selected"; }?>><?php echo $value['name']; ?></option>
	...
	<div class="form-group col-xs-6">
      <label class="control-label col-xs-6" for="from">From Date:</label>
      <div class="col-xs-6">          
	...
	<div class="form-group col-xs-6">
      <label class="control-label col-xs-6" for="to">To Date:</label>
      <div class="col-xs-6">          
				...
				?> 
											...
											<!--  <td><a href="javascript:void(0)" onClick="javascript:placeMarker(<?php echo $value['latitude']; ?>,<?php echo $value['longitude']; ?>,<?php echo round($value['speed']*1.852,2); ?>,<?php	echo $value['course'];?>);"> <?php echo $value['valid']; ?></a></td>-->
											   <td><?php echo $value['deviceid']; ?></td>
												<td><a href="javascript:void(0)" onClick="javascript:placeMarker(<?php echo $value['latitude']; ?>,<?php echo $value['longitude']; ?>);"><?php echo $value['positionid']; ?></a></td>
                                                <td><?php echo $value['servertime']; ?></td>
                                                <td><?php echo $value['type']; ?></td>
                                                <td><?php echo $value['qty']; ?></td>
                                                <td><?php echo $value['fuel_level']; ?></td>
    ...
    "aLengthMenu": [
      ...
      [5,10, 25, 50, "all"]
        ...
        .on( 'key-focus', function ( e, datatable, cell ) {
			 ...
			 placeMarker(rowData[6],rowData[7]);
            events.html( '<div>Lat '+ rowData[6] +' Long '+rowData[7]+'</div>' );
        } )
